                            ...
                            <div class="row px-3">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('cif') is-invalid @enderror" id="editCif"
                                            name="cif" placeholder="CIF nasabah"
                                            value="{{ $document->cif ?? old('cif') }}" required type="text">
                                        @error('cif')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('nik') is-invalid @enderror" id="editNik"
                                            name="nik" placeholder="NIK nasabah"
                                            value="{{ $document->nik_nasabah ?? old('nik') }}" required type="number"
                                            min="0">
                                        @error('nik')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label for="editRekening"
                                            class="mb-0 form-label col-form-label-sm">Rekening</label>
                                        <input class="form-control @error('rekening') is-invalid @enderror"
                                            id="editRekening" name="rekening" placeholder="Rekening nasabah"
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('telepon') is-invalid @enderror"
                                            id="editTelepon" name="telepon" placeholder="Telepon nasabah"
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('pekerjaan') is-invalid @enderror"
                                            id="editPekerjaan" name="pekerjaan" placeholder="Pekerjaan nasabah"
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('dokumen') is-invalid @enderror"
                                            id="editDokumen" name="dokumen" placeholder="Input informasi dokumen"
                                            value="{{ $document->no_dokumen ?? old('dokumen') }}" required
                                            type="text">
                                        @error('dokumen')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control w-100 segmen" id="editSegmen" name="segmen"
                                            required>
                                            <option></option>
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="editAkad" class="mb-0 form-label col-form-label-sm">Tanggal
                                            Akad</label>
                                        <input class="form-control @error('akad') is-invalid @enderror" id="editAkad"
                                            name="akad" value="{{ $document->akad ?? old('akad', date('Y-m-d')) }}"
                                            required type="date">
                                        @error('akad', date('Y-m-d'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('jatuh_tempo') is-invalid @enderror"
                                            ...
                                            value="{{ $document->jatuh_tempo ?? old('jatuh_tempo', date('Y-m-d')) }}"
                                            required type="date">
                                        @error('jatuh_tempo', date('Y-m-d'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control baris" style="width: 100%;" id="editBaris"
                                            name="baris" required>
                                            <option></option>
                                            @foreach ($rows as $row)
                                                <option value="{{ $row->number }}"
                                                    {{ $document->row == $row->number ? 'selected' : (old('baris') == $row->number ? 'selected' : '') }}>
                                                    Baris {{ $row->number }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <table class="table table-bordered text-sm w-100" id="agunans-table">
                                ...
                                <tbody>
                                    @foreach ($document->agunans as $key => $agunan)
                                        <tr>
                                            <td>
                                                <input type="text" name="agunans[{{ $key }}][number]"
                                                    class="form-control" placeholder="Tulis nama agunan"
                                                    value="{{ $agunan->rfid_number }}" disabled>
                                            </td>
                                            <td><input type="text" name="agunans[{{ $key }}][name]"
                                                    class="form-control" placeholder="Tulis nama agunan"
                                                    value="{{ $agunan->name }}" required></td>
                                            <td><input type="text" name="agunans[{{ $key }}][number]"
                                                    class="form-control" placeholder="Tulis nomor agunan"
                                                    value="{{ $agunan->number }}" required></td>
                                            <td><button type="button"
                                                    class="btn btn-danger btn-sm remove-item rounded-partner"><i
                                                        class="fas fa-trash"></i></button></td>
                                        </tr>
