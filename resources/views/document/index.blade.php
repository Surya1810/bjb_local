...
<div class="modal fade" id="addDocument" aria-labelledby="addDocumentLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('document.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    ...
                    <div class="row px-3">
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control tag" style="width: 100%;" id="tag" name="tag" required>
                                    <option></option>
                                    @foreach ($tags as $tag)
                                    <option value="{{ $tag->rfid_number }}" {{ old('tag')==$tag->rfid_number ?
                                        'selected' : '' }}>
                                        {{ $tag->rfid_number }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('cif') is-invalid @enderror" id="cif" name="cif"
                                    placeholder="CIF nasabah" value="{{ old('cif') }}" required type="text">
                                @error('cif')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik"
                                    placeholder="NIK nasabah" value="{{ old('nik') }}" required type="number" min="0">
                                @error('nik')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama"
                                    placeholder="Nama nasabah" value="{{ old('nama') }}" required type="text">
                                @error('nama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('telepon') is-invalid @enderror" id="telepon"
                                    name="telepon" placeholder="Telepon nasabah" value="{{ old('telepon') }}" required
                                    type="tel" min="0">
                                @error('telepon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('dokumen') is-invalid @enderror" id="dokumen"
                                    name="dokumen" placeholder="Input informasi dokumen" value="{{ old('dokumen') }}"
                                    required type="text">
                                @error('dokumen')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('akad') is-invalid @enderror" id="akad" name="akad"
                                    required type="date">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                <label for="jatuh_tempo" class="mb-0 form-label col-form-label-sm">Tanggal Jatuh
                                    Tempo</label>
                                <input class="form-control @error('jatuh_tempo') is-invalid @enderror" id="jatuh_tempo"
                                    name="jatuh_tempo" required type="date">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('lama') is-invalid @enderror" id="lama" name="lama"
                                    placeholder="Input lama pinjaman (bulan)" value="{{ old('lama') }}" required
                                    type="number" min="0">
                                @error('lama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nilai" class="form-control price" placeholder="Input nilai"
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('ruangan') is-invalid @enderror" id="ruangan"
                                    name="ruangan" placeholder="Tulis ruangan " value="{{ old('ruangan') }}" required
                                    type="text">
                                @error('ruangan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control baris" style="width: 100%;" id="baris" name="baris"
                                    required>
                                    <option></option>
                                    @foreach ($rows as $row)
                                    <option value="{{ $row->number }}" {{ old('baris')==$row->number ? 'selected' : ''
                                        }}>
                                        Baris {{ $row->number }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control rak" style="width: 100%;" id="rak" name="rak" required>
                                    <option></option>
                                    @foreach ($racks as $rack)
                                    <option value="{{ $rack->number }}" {{ old('rak')==$rack->number ? 'selected' : ''
                                        }}>
                                        Rak {{ $rack->number }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('box') is-invalid @enderror" id="box" name="box"
                                    placeholder="Tulis box" value="{{ old('box') }}" required type="text">
                                @error('box')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                    name="keterangan" placeholder="Tulis keterangan " value="{{ old('keterangan') }}"
                                    type="text">
                                @error('keterangan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <table class="table table-bordered text-sm w-100" id="agunans-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-danger btn-sm remove-item rounded-partner"><i
...
<!-- Modal Edit Document-->
<div class="modal fade" id="editDocument{{ $document->id }}" aria-labelledby="editDocumentLabel{{ $document->id }}"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('document.update', $document->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    <div class="row px-3">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editCif" class="mb-0 form-label col-form-label-sm">CIF</label>
                                <input class="form-control @error('cif') is-invalid @enderror" id="editCif" name="cif"
                                    placeholder="CIF nasabah" value="{{ $document->cif ?? old('cif') }}" required
                                    type="text">
                                @error('cif')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editNik" class="mb-0 form-label col-form-label-sm">NIK</label>
                                <input class="form-control @error('nik') is-invalid @enderror" id="editNik" name="nik"
                                    placeholder="NIK nasabah" value="{{ $document->nik_nasabah ?? old('nik') }}"
                                    required type="number" min="0">
                                @error('nik')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editNama" class="mb-0 form-label col-form-label-sm">Nama</label>
                                <input class="form-control @error('nama') is-invalid @enderror" id="editNama"
                                    name="nama" placeholder="Nama nasabah"
                                    value="{{ $document->nama_nasabah ?? old('nama') }}" required type="text">
                                @error('nama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editRekening" class="mb-0 form-label col-form-label-sm">Rekening</label>
                                <input class="form-control @error('rekening') is-invalid @enderror" id="editRekening"
                                    name="rekening" placeholder="Rekening nasabah"
                                    value="{{ $document->rekening_nasabah ?? old('rekening') }}" required type="number"
                                    min="0">
                                @error('rekening')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editTelepon" class="mb-0 form-label col-form-label-sm">Telepon</label>
                                <input class="form-control @error('telepon') is-invalid @enderror" id="editTelepon"
                                    name="telepon" placeholder="Telepon nasabah"
                                    value="{{ $document->telp_nasabah ?? old('telepon') }}" required type="tel" min="0">
                                @error('telepon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editPekerjaan" class="mb-0 form-label col-form-label-sm">Pekerjaan</label>
                                <input class="form-control @error('pekerjaan') is-invalid @enderror" id="editPekerjaan"
                                    name="pekerjaan" placeholder="Pekerjaan nasabah"
                                    value="{{ $document->pekerjaan_nasabah ?? old('pekerjaan') }}" required type="text">
                                @error('pekerjaan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editInstansi" class="mb-0 form-label col-form-label-sm">Instansi</label>
                                <input class="form-control @error('instansi') is-invalid @enderror" id="editInstansi"
                                    name="instansi" placeholder="Instansi nasabah"
                                    value="{{ $document->instansi ?? old('instansi') }}" required type="text">
                                @error('instansi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editAlamat" class="mb-0 form-label col-form-label-sm">Alamat</label>
                                <input class="form-control @error('alamat') is-invalid @enderror" id="editAlamat"
                                    name="alamat" placeholder="Alamat nasabah"
                                    value="{{ $document->alamat_nasabah ?? old('alamat') }}" required type="text">
                                @error('alamat')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editDokumen" class="mb-0 form-label col-form-label-sm">Dokumen</label>
                                <input class="form-control @error('dokumen') is-invalid @enderror" id="editDokumen"
                                    name="dokumen" placeholder="Input informasi dokumen"
                                    value="{{ $document->no_dokumen ?? old('dokumen') }}" required type="text">
                                @error('dokumen')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editSegmen" class="mb-0 form-label col-form-label-sm">Segmen</label>
                                <select class="form-control w-100 segmen" id="editSegmen" name="segmen" required>
                                    <option></option>
                                    <option value="Konsumer" {{ $document->segmen == 'Konsumer' ? 'selected' :
                                        (old('segmen')=='Konsumer' ? 'selected' : '') }}>
                                        Konsumer
                                    </option>
                                    <option value="UMKM" {{ $document->segmen == 'UMKM' ? 'selected' :
                                        (old('segmen')=='UMKM' ? 'selected' : '') }}>
                                        UMKM
                                    </option>
                                    <option value="KPR" {{ $document->segmen == 'KPR' ? 'selected' :
                                        (old('segmen')=='KPR' ? 'selected' : '') }}>
                                        KPR
                                    </option>
                                    <option value="Komersial" {{ $document->segmen == 'Komersial' ? 'selected' :
                                        (old('segmen')=='Komersial' ? 'selected' : '') }}>
                                        Komersial
                                    </option>
                                    <option value="Korporasi" {{ $document->segmen == 'Korporasi' ? 'selected' :
                                        (old('segmen')=='Korporasi' ? 'selected' : '') }}>
                                        Korporasi
                                    </option>
                                </select>
                                @error('segmen')
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="editCabang" class="mb-0 form-label col-form-label-sm">Cabang</label>
                                <input class="form-control @error('cabang') is-invalid @enderror" id="editCabang"
                                    name="cabang" placeholder="Input cabang"
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                <label for="editAkad" class="mb-0 form-label col-form-label-sm">Tanggal Akad</label>
                                <input class="form-control @error('akad') is-invalid @enderror" id="editAkad"
                                    name="akad" value="{{ $document->akad ?? old('akad', date('Y-m-d')) }}" required
                                    type="date">
                                @error('akad', date('Y-m-d'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                <label for="editJatuhTempo" class="mb-0 form-label col-form-label-sm">Tanggal Jatuh
                                    Tempo</label>
                                <input class="form-control @error('jatuh_tempo') is-invalid @enderror"
                                    id="editJatuhTempo" name="jatuh_tempo"
                                    value="{{ $document->jatuh_tempo ?? old('jatuh_tempo', date('Y-m-d')) }}" required
                                    type="date">
                                @error('jatuh_tempo', date('Y-m-d'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                <label for="editLama" class="mb-0 form-label col-form-label-sm">Lama Pinjaman <small
                                        class="text-danger">*Bulan</small></label>
                                <input class="form-control @error('lama') is-invalid @enderror" id="editLama"
                                    name="lama" placeholder="Input lama pinjaman (bulan)"
                                    value="{{ $document->lama ?? old('lama') }}" required type="number" min="0">
                                @error('lama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control baris" style="width: 100%;" id="editBaris" name="baris"
                                    required>
                                    <option></option>
                                    @foreach ($rows as $row)
                                    <option value="{{ $row->number }}" {{ $document->row == $row->number ? 'selected' :
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control rak" style="width: 100%;" id="editRak" name="rak" required>
                                    <option></option>
                                    @foreach ($racks as $rack)
                                    <option value="{{ $rack->number }}" {{ $document->rack == $rack->number ? 'selected'
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                <label for="editRuangan" class="mb-0 form-label col-form-label-sm">Ruangan</label>
                                <input class="form-control @error('ruangan') is-invalid @enderror" id="editRuangan"
                                    name="ruangan" placeholder="Input Ruangan"
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('box') is-invalid @enderror" id="editBox" name="box"
                                    placeholder="Input box" value="{{ $document->box ?? old('box') }}" required
                                    type="text">
                                @error('box')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <table class="table table-bordered text-sm w-100" id="agunans-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="agunans[{{ $key }}][number]" class="form-control"
                                        placeholder="Tulis nomor agunan" value="{{ $agunan->number }}" required></td>
                                <td><button type="button" class="btn btn-danger btn-sm remove-item rounded-partner"><i
                                            class="fas fa-trash"></i></button></td>
                            </tr>
                            @endforeach
