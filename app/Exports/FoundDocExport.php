...
class FoundDocExport implements FromCollection, WithHeadings, WithStyles
{
    public function collection()
    {
        return Document::where('is_there', true) // Hanya mengambil dokumen yang ditemukan
    ...
    {
        $date = Carbon::now()->translatedFormat('l, d F Y'); // Format tanggal bahasa lokal
        return [
            ["BERITA ACARA PENEMUAN DOKUMEN"], // Judul laporan
            [""], // Baris kosong
            ["Pada hari ini, {$date}, telah dilakukan pengecekan dokumen dengan hasil sebagai berikut:"], // Deskripsi awal
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $rowCount = Document::where('is_there', true)->count() + 5; // Jumlah data + header
